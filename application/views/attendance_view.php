        ...
        <div class="p-4 mb-2 bg-white rounded-lg shadow-md border-t-4 border-blue-500 w-sm mr-2 max-h-40">
            <ul>
                <li class="flex items-center mb-2">
                    <span class="w-6 h-6 rounded-full bg-yellow-300 mr-2 flex items-center justify-center"><i class="fas fa-calendar-check"></i></span>
                    <span class="text-gray-800">Present</span>
                </li>
                <li class="flex items-center mb-2">
                    <span class="w-6 h-6 rounded-full bg-red-300 mr-2 flex items-center justify-center"><i class="far fa-frown"></i></span>
                    <span class="text-gray-800">Absent</span>
                </li>
                <li class="flex items-center">
                    ...
                    <span class="text-gray-800">Holiday</span>
                </li>
            </ul>
        </div>
    ...
    $('#calendar').fullCalendar({
        ...
        dayRender: function(date, cell) {
            ...
            if (holiday) {
                ...
                cell.append('<div style="color: blue; font-weight: bold;font-size:15px;">' + holiday.title + '</div>');
