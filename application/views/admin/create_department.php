<!-- application/views/admin/create_Department_view.php -->

<div class=" mx-auto p-6 bg-white mt-5">
    <h2 class="text-2xl font-bold mb-4">Create New Department</h2>

    <?php echo form_open('Departments/create_department', ['class' => 'w-full max-w-lg']); ?>
        <div class="mb-4">
        ...
        <div class="flex justify-end">
            <button type="submit" class="blue-bg text-white font-bold py-2 px-4 rounded hover:bg-blue-700 focus:outline-none focus:shadow-outline">Create Department</button>
        </div>
    <?php echo form_close(); ?>
</div>
