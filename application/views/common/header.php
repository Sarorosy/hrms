...
.offcanvas {
    ...
    box-shadow: -2px 0 5px rgba(0, 0, 0, 0.5); /* Change to negative for right shadow */
    transform: translateX(100%); /* Change to translateX(100%) for right */
...
.message-item.unread {
    background-color: #ebf8ff; /* Blue-100 background color for unread messages */
}
